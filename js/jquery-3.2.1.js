! function(e, t) {
  ...
  k.extend({
    ...
    clone: function(e, t, n) {
      ...
      if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || k.isXMLDoc(e)))
        for (a = le(c), r = 0, i = (o = le(e)).length; r < i; r++) s = o[r], "input" === (l = (u = a[r]).nodeName.toLowerCase()) && oe.test(s.type) ? u.checked = s.checked : "input" !== l && "textarea" !== l || (u.defaultValue = s.defaultValue);
      if (t)
        if (n)
  ...
  k.Animation = k.extend(at, {
    ...
    tweener: function(e, t) {
      k.isFunction(e) ? (t = e, e = ["*"]) : e = e.match(P);
